...
const testimonials = [
  ...
  },
  {
    name: "M・Iさん（30代・会社員）",
    course: "非属人YouTubeコース（1年）",
    text: "自分の商品がなかったので、まずInstagramで集客する導線から教わりました。そこからアフィリエイトにつなげて、3ヶ月で月30万円に到達。YouTube以外にも同じ考え方が使えるのが大きかったです。",
    rating: 5,
  },
  {
    name: "S・Kさん（20代・フリーランス）",
    course: "非属人YouTubeコース（1年）",
    text: "Threadsで集客してnoteへ誘導し、LINEでローンチをかける流れを一緒に組んでもらいました。結果、noteとオンラインスクールの両方を販売できました。媒体ごとの役割を分けて設計する考え方が身につきました。",
    rating: 5,
  },
  {
    name: "Y・Nさん（20代・主婦）",
