...
export const FAQS = [
  ...
  {
    q: "YouTube以外のSNSにも使えますか？",
    a: "使えます。商品や目的に合わせて、Instagram・Threads・X・TikTok・note・YouTubeなどから優先する媒体を選びます。企画・投稿・数字の見方だけでなく、LINEや個別相談へつなぐ販売導線まで一緒に整理します。完全特別コンサルでは、これらの媒体を横断して伴走します。",
  },
  {
    q: "スマホしか持っていなくても始められますか？",
    a: "始められます。投稿・企画・AIを使った文章作成はスマホでも進められます。ただし、Adobe Premiere Proを使った本格的な動画編集にはパソコンが必要です。今お使いの環境で何がどこまでできるかは、個別相談で確認したうえでご案内します。",
  },
  {
    q: "自分の商品がなくても大丈夫ですか？",
    a: "問題ありません。まず何を扱うかを決めるところから一緒に整理します。商品づくりから始める方もいれば、他社商品の紹介から入る方もいます。今の状況とご希望を伺ったうえで、無理のない進め方をご提案します。",
  },
  {
