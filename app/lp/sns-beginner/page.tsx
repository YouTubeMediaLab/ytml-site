...
import { BEGINNER_SNS_LP_LINE_URL } from "@/config/site";
...
export default function BeginnerSocialLandingPage() {
  return (
    <AcquisitionLandingPage
      source="social"
      ctaUrlOverride={BEGINNER_SNS_LP_LINE_URL}
    />
  );
}
