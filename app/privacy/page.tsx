...
const sections = [
  ...
  },
  {
    title: "2. 個人情報の収集",
    content:
      "当社は、お問い合わせ、公式LINE、申込フォーム、ヒアリングフォーム、予約フォーム、契約およびサービス提供の際に、以下の情報を必要な範囲で収集します。\n・氏名、会社名・屋号、住所、電話番号、メールアドレス等の連絡先\n・SNSアカウント、Webサイト、商品・サービス、売上導線その他の事業に関する情報\n・お問い合わせ・ヒアリングへの回答、相談内容、予約日時\n・契約、請求および支払いに関する情報\n・Cookie、アクセスログ、利用端末等のサービス利用情報",
  },
  {
    title: "3. 個人情報の利用目的",
    content:
      "収集した個人情報は、以下の目的に利用します。\n・お問い合わせへの回答、無料診断・個別相談および予約管理\n・お客様の状況に応じたサービスの提案、契約、請求および本人確認\n・教材提供、SNS・販売導線の設計・構築、サポートその他契約したサービスの実施\n・サービス運営上の重要なお知らせおよび、同意をいただいた方への案内配信\n・サービス品質の改善、利用状況の分析および不正利用の防止\n・法令に基づく対応\n\n上記以外の目的で利用する場合は、あらかじめご本人の同意を取得します。",
  },
  {
    title: "4. 個人情報の第三者提供",
    content:
  ...
  },
  {
    ...
    content:
      "当社は、利用目的の達成に必要な範囲で、公式LINE、UTAGE、Googleフォーム、予約・決済・電子契約・クラウド保管等の外部サービスを利用し、個人情報の取り扱いを委託する場合があります。この場合、委託先を適切に選定し、契約その他の方法により必要かつ適切な監督を行います。",
  },
  {
    title: "6. 個人情報の管理",
    content:
